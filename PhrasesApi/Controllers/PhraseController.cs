...
namespace Phrases.API.Controllers
{
    ...
    public class PhraseController : ControllerBase
    {
        ...
        //public async Task<ActionResult<Phrase>> GetAllByTagIdOrderById(Guid tagId)
        //{
        //    try
        //    {
        ...
        ////Get all by tagId ordered by likes
        //[HttpGet("GetAllByTagIdOrderByLikes/{tagId}")]
        //public async Task<ActionResult<Phrase>> GetAllByTagIdOrderByLikes(Guid tagId)
        //{
        //    try
        //    {
        ...
        ////Get by id
        //[HttpGet("GetById/{id}")]
        //public async Task<ActionResult<Phrase>> GetById(Guid id)
        //{
        //    try
        //    {
        ...
        //public async Task<IActionResult> UpdateLikes(Guid id, int likes)
        //{
        //    try
        //    {
        ...
        //public async Task<ActionResult> Update(Guid id, [FromBody] Phrase evnt)
        //{
        //    try
        //    {
        //        if (evnt == null)
